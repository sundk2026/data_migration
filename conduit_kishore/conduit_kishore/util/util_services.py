...
class UTILServices:
    ...
    def GetreferenceIqgeoTable(ne_object_category, ne_type_name):
        ret_value=""
        if ne_object_category=='COPPER' and ne_type_name =='CAPACITOR' : ret_value ='copper_capacitor' 
        if ne_object_category=='COPPER' and ne_type_name =='CARRIER TERMINAL' : ret_value ='st_equip_carrier_terminal' 
        if ne_object_category=='COPPER' and ne_type_name =='CDF' : ret_value ='st_equipment_cdf' 
        if ne_object_category=='COPPER' and ne_type_name =='CROSS CONNECT' : ret_value ='st_equip_copper_cross_connect_terminal' 
        if ne_object_category=='COPPER' and ne_type_name =='ISOLATOR' : ret_value ='st_equip_isolator' 
        if ne_object_category=='COPPER' and ne_type_name =='LOAD COIL' : ret_value ='copper_load_coil' 
        if ne_object_category=='COPPER' and ne_type_name =='NID' : ret_value ='copper_nid' 
        if ne_object_category=='COPPER' and ne_type_name =='PROTECTOR' : ret_value ='st_equip_copper_protector' 
        if ne_object_category=='COPPER' and ne_type_name =='READY ACCESS TERM' : ret_value ='st_equip_ready_access_terminal' 
        if ne_object_category=='COPPER' and ne_type_name =='REPEATER' : ret_value ='st_equip_copper_repeater' 
        if ne_object_category=='COPPER' and ne_type_name =='TERMINAL' : ret_value ='st_equip_ready_access_terminal' 
        if ne_object_category=='COPPER' and ne_type_name =='TRANSFORMER' : ret_value ='copper_transformer' 
        if ne_object_category=='FIBER' and ne_type_name =='COUPLER' : ret_value ='' 
        if ne_object_category=='FIBER' and ne_type_name =='FDF' : ret_value ='st_equip_fdf' 
        if ne_object_category=='FIBER' and ne_type_name =='FIP' : ret_value ='st_equip_fip' 
        if ne_object_category=='FIBER' and ne_type_name =='FRAME' : ret_value ='st_equip_frame' 
        if ne_object_category=='FIBER' and ne_type_name =='LOOP BACK' : ret_value ='' 
        if ne_object_category=='FIBER' and ne_type_name =='ONT' : ret_value ='fiber_ont' 
        if ne_object_category=='FIBER' and ne_type_name =='SOT' : ret_value ='st_equip_sot' 
        if ne_object_category=='FTTX' and ne_type_name =='FDH' : ret_value ='st_equip_fdh' 
        if ne_object_category=='FTTX' and ne_type_name =='FDT' : ret_value ='st_equip_fdt' 
        if ne_object_category=='FTTX' and ne_type_name =='FSB' : ret_value ='st_equip_fsb' 
        if ne_object_category=='FTTX' and ne_type_name =='FST' : ret_value ='fiber_mst' 
        if ne_object_category=='FTTX' and ne_type_name =='IFDH' : ret_value ='isp_fdh' 
        if ne_object_category=='FTTX' and ne_type_name =='TO' : ret_value ='st_equipment_tether_only' 
        if ne_object_category=='MONITORING' and ne_type_name =='MONITORING' : ret_value ='st_equip_monitoring' 
        if ne_object_category=='PRESSURIZATION' and ne_type_name =='AIR SOURCE' : ret_value ='st_equip_air_source' 
        if ne_object_category=='PRESSURIZATION' and ne_type_name =='ALARM' : ret_value ='st_equip_alarm' 
        if ne_object_category=='PRESSURIZATION' and ne_type_name =='FLOW FINDER' : ret_value ='st_equip_flow_finder' 
        if ne_object_category=='PRESSURIZATION' and ne_type_name =='FLOW TRANSDUCER' : ret_value ='st_equip_flow_transducer' 
        if ne_object_category=='PRESSURIZATION' and ne_type_name =='MANIFOLD' : ret_value ='st_equip_manifold' 
        if ne_object_category=='PRESSURIZATION' and ne_type_name =='METERING PANEL' : ret_value ='st_equip_metering_Panel' 
        if ne_object_category=='PRESSURIZATION' and ne_type_name =='PRESSURE TRANSDUCER' : ret_value ='st_equip_pressure_transducer' 
        if ne_object_category=='PRESSURIZATION' and ne_type_name =='VALVE' : ret_value ='st_equip_Valve' 
        if ne_object_category=='WIRELESS' and ne_type_name =='ANTENNA' : ret_value ='cellular_antenna' 
        if ne_object_category=='WIRELESS' and ne_type_name =='TERMINATION' : ret_value ='st_equip_termination' 
    ...
    def getOffsetGeom(tempGeo, srcCRS, tgtCRS,childno):
        offset_distance = 0.00001605
        offset_y = tempGeo.y + (childno * offset_distance)
        offset_geom = Point(tempGeo.x, offset_y)
        # Reprojection of data if original data is in other then GCS - WGS84
        transformer = Transformer.from_crs(srcCRS,tgtCRS,always_xy=True)
        trangeom=transform(transformer.transform,offset_geom)
        shaply_geom=shape(trangeom)
        wkb_data=shaply_geom.wkb_hex
        return wkb_data
