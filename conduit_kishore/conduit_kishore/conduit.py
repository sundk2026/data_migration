...
class IQGeoCDIF:
    ...
    def ProcessRecords(self):
        if self.Initialized==True:
            ...
            if self.new_ug_route: pd.DataFrame(self.new_ug_route).to_csv(self.folder_path+ "\\ug_route.csv", index=False)
            if self.new_oh_route: pd.DataFrame(self.new_oh_route).to_csv(self.folder_path+ "\\oh_route.csv", index=False)
